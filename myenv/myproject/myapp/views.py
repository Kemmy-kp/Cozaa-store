...
STRIPE_SECRET_KEY = "sk_test_51OySrpSIrJqxWSQIDOCdS7eefdzETixJyiv1YCi7gQPwaE4V1xG6eLxBPwvAj8Yw21LZ3FpKaiRP8fyEAnhsLogn00Xuji3XGK"
...
def scart(request):
    ...
    return render(request,"scart.html",{'cart':cart,'net':net,'ship':ship}) 
